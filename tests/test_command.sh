...
iqkm -i genomes/GCF_003018455.1_ASM301845v1_genomic.fna -o output_identification/ --help_dir ../help_dir/ -n 4 
...
iqkm -i tests/genomes/ERR1753690_metagenome.fna -o tests/output_iqkm/ --help_dir ../iqKM_copy/help_dir --fq tests/reads/ERR1753690_1.fastq.gz --rq tests/reads/ERR1753690_2.fastq.gz --meta --quantify -n 4
# the example output folder structure, final KM identification summary is in KM_assignment_filtered
